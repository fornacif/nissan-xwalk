...
export default async function decorate(block) {
    ...
    const image1 = config.image1.replace('width=750&format=jpeg', 'width=3000&format=webp');
    const image2 = config.image2.replace('width=750&format=jpeg', 'width=3000&format=webp');
    const image3 = config.image3.replace('width=750&format=jpeg', 'width=3000&format=webp');
